...
Public Class lap_keputusan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi.lap_keputusan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_keputusan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_keputusan = New lap_keputusan()
        rpt.Site = Me.Site
        Return rpt
    End Function
